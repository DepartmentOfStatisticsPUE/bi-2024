...
- zwięzły opis projektu dotyczący wyboru estymatorów oraz opis danych
...
2. wygenerowano zmienną $X_1 \sim (0,1)$ oraz $X_2 \sim \chi(2)$
3. wygenerowano zmienną/e $Y$ zgodnie z poniższym wzorem
